(window.NREUM || (NREUM = {})).loader_config = {
    xpid: "XAcEV19XGwcCUldTDwg=",
    licenseKey: "e671e25255",
    applicationID: "4266189"
};
...
window.NREUM || (NREUM = {}), __nr_require = function(t, n, e) {
    ...
    1: [ function(t, n, e) {
        ...
        try {
            o = localStorage.getItem("__nr_flags").split(","), console && "function" == typeof console.log && (s.console = !0, 
            o.indexOf("dev") !== -1 && (s.dev = !0), o.indexOf("nr_dev") !== -1 && (s.nrDev = !0));
        } catch (c) {}
    ...
    2: [ function(t, n, e) {
        ...
        function UncaughtException(t, n, e) {
            this.message = t || "Uncaught error with no additional information", this.sourceURL = n, 
            this.line = e;
        }
        function o(t, n) {
            var e = n ? null : c.now();
        ...
        try {
            ...
            "stack" in h && (t(9), t(8), "addEventListener" in window && t(5), c.xhrWrappable && t(10), 
            d = !0);
        }
    ...
    5: [ function(t, n, e) {
        ...
        n.exports = a, "getPrototypeOf" in Object ? (r(document), r(window), r(f.prototype)) : f.prototype.hasOwnProperty(u) && (o(window), 
        o(f.prototype)), a.on(u + "-start", function(t, n) {
    ...
    8: [ function(t, n, e) {
        ...
        n.exports = r, o.inPlace(window, [ "r" + i, "mozR" + i, "webkitR" + i, "msR" + i ], "raf-"), 
    ...
    9: [ function(t, n, e) {
        ...
        n.exports = i, a.inPlace(window, [ s, "setImmediate" ], s + d), a.inPlace(window, [ c ], c + d), 
    ...
    10: [ function(t, n, e) {
        ...
        if (c(p, x), x.prototype = p.prototype, d.inPlace(x.prototype, [ "open", "send" ], "-xhr-", s), 
    ...
    11: [ function(t, n, e) {
        ...
        function i(t) {
            ...
            e = !!r.enabled), e) if (t.sameOrigin) n = !0; else if (r.allowed_origins instanceof Array) for (var o = 0; o < r.allowed_origins.length; o++) {
    ...
    12: [ function(t, n, e) {
        function r(t) {
            ...
            if (!this.ended) {
                ...
                n.aborted || (e.duration = a.now() - this.startTime, this.loadCaptureCalled || 4 !== t.readyState ? null == n.status && (n.status = 0) : i(this, t), 
                e.cbTime = this.cbTime, u.emit("xhr-done", [ t ], t), s("xhr", [ n, e, this.startTime ]));
            }
        }
        function o(t, n) {
            var e = c(n), r = t.params;
            r.host = e.hostname + ":" + e.port, r.pathname = e.pathname, t.parsedOrigin = c(n), 
        ...
        if (a.xhrWrappable) {
            ...
            a.features.xhr = !0, t(10), t(6), u.on("new-xhr", function(t) {
                ...
                n.lastSize = null, n.loadCaptureCalled = !1, t.addEventListener("load", function(e) {
                    i(n, t);
                ...
                var n, e = t[1] || {};
                "string" == typeof t[0] ? n = t[0] : t[0] && t[0].url && (n = t[0].url), n && (this.parsedOrigin = c(n), 
                ...
                if (r && r.header) {
                    ...
                    if ("string" == typeof t[0]) {
                        ...
                        i.headers = new Headers(e.headers || {}), i.headers.set("newrelic", o), this.dt = r, 
    ...
    13: [ function(t, n, e) {
        ...
        n.exports = function(t) {
            ...
            o.port && "0" !== o.port || (o.port = "https" === i[0] ? "443" : "80"), o.hostname = n.hostname || e.hostname, 
            o.pathname = n.pathname, o.protocol = i[0], "/" !== o.pathname.charAt(0) && (o.pathname = "/" + o.pathname);
            var a = !n.protocol || ":" === n.protocol || n.protocol === e.protocol, s = n.hostname === document.domain && n.port === e.port;
            return o.sameOrigin = a && (!n.hostname || s), "/" === o.pathname && (r[t] = o), 
            o;
        };
    }, {} ],
    14: [ function(t, n, e) {
    ...
    15: [ function(t, n, e) {
        ...
        a(d, function(t, n) {
            u[n] = o(l + n, !0, "api");
        }), u.addPageAction = o(l + "addPageAction", !0), u.setCurrentRouteName = o(l + "routeName", !0), 
    ...
    19: [ function(t, n, e) {
        function r() {
            ...
            for (var o, i = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx", a = "", s = 0; s < i.length; s++) o = i[s], 
    ...
    loader: [ function(t, n, e) {
        ...
        }, x = w && v && v[h] && !/CriOS/.test(navigator.userAgent), b = n.exports = {
            offset: s,
            now: a,
            origin: g,
            features: {},
        ...
        t(15), t(18), p[h] ? (p[h]("DOMContentLoaded", i, !1), l[h]("load", r, !1)) : (p[m]("onreadystatechange", o), 
        l[m]("onload", r)), c("mark", [ "firstbyte", s ], null, "api");
        var E = 0, O = t(23);
    }, {} ],
